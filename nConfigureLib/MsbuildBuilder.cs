...
namespace nConfigureLib
{
    ...
    {
        public void CreateBuildFile(List<Project> projects, XmlWriter writer)
        {
        ...
        private static void CreateItemGroup(XmlWriter w, List<Project> projects)
        {
        ...
        private static void CreateProjectTarget(XmlWriter w, Project project)
        {
            ...
            {
                if (enumerator.Current.Project != null)
                {
                    ...
                    dependsOn.Append(DeMsbuildString(enumerator.Current.Project.FullAbsoluteFileName));
                }
            }
